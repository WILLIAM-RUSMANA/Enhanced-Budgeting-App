...
public class ExpenseBuilder {
    HashMap<String, String[]> categoriesMap = new HashMap<>() {{
        ...
        // d
        put("Depreciation", new String[]{"300000", "Yearly"});
    ...
    public ArrayList<Expense> build(ArrayList <Expense> expenses) {

        // categorize Expenses into different arrayLists
            ...
            switch (halfYears) {
                case 1 -> {
                    for (String semiAnnualCategory : semiAnnual) {
                        ...
                        expenses.add(new Expense(amount, year, randomInt(1,6), date, semiAnnualCategory, "", "Semi-Annual"));
                    }
    ...
    private int randomInt(int start, int end) {  // Generates a random number from the range of start-end inclusive
    ...
    private HashMap<String, Integer> makeDateMap(ArrayList<String> categories) {
        ...
        for (String category : categories) {
            categoryPaymentDate.put(category, randomInt(1, 28));
        }
